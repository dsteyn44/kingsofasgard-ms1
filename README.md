...
This is essentially a website for a real nordic melodic death metal band in Sweden call "King of Asgård" - with a bit if a twist. Since most death metal bands are pretty much the same; why should someone listen to their music? What does their music give of value? What besides the music keeps their fans from coming back.
...
- Navigation Bar: Too include links to Home button, The Band page, The Fanwall (with a dropdown menuthat includes links to The Fanwall, ool Stuff and Skål! pages). It must also include a "Contact Us" modal fto send simple information.

The Footer 

- Links to social media platforms that are related to the product. Must be fixed and visible at all times.
...
- A little infromation how the arrived.  
- A little infromation how the arrived. 
